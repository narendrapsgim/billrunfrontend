...
export default () => {
  return (
    <Route path="/" component={App}>
      ...
      <Route path="/dashboard" name="dashboard" component={RequireAuth(Dashboard)} title="Dashboard" />
      <Route path="/plans" name="plans" component={RequireAuth(PlansList)} title="Plans"/>
