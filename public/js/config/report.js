export default {
  ...
  fields: {
    ...
    bills: [
      ...
      { id: 'left_to_pay', type: 'number', title: 'Left to Pay' },
      { id: 'aid', type: 'number', title: 'Aid' },
      { id: 'invoice_id', type: 'number', title: 'Invoice ID' },
      { id: 'due_date', type: 'date', title: 'Due Date' },
      { id: 'due', type: 'number', title: 'Due' },
      { id: 'payer_name', type: 'string', title: 'Payer Name' },
      { id: 'amount', type: 'number', title: 'Amount' },
      { id: 'lastname', type: 'string', title: 'Last Name' },
      { id: 'firstname', type: 'string', title: 'First Name' },
      { id: 'payment_method', type: 'string', title: 'Payment Method' },
      { id: 'urt', type: 'date', title: 'URT' },
      { id: 'invoice_date', type: 'date', title: 'Invoice Date' },
      { id: 'total_paid', type: 'number', title: 'Total Paid' },
      { id: 'left_to_pay', type: 'number', title: 'Left to Pay' },
      { id: 'vatable_left_to_pay', type: 'number', title: 'Vatable Left to Pay' },
      { id: 'waiting_payments', type: 'number', title: 'Waiting Payments' },
      { id: 'paid',
        inputConfig: {
          inputType: 'select',
          options: [
