export default {
  ...
  fields: {
    ...
    bills: [
      { id: 'type',
        inputConfig: {
          ...
          options: [
            ...
            { value: 'rec', label: 'payment' },
          ],
        },
      },
      { id: 'canceled', type: 'boolean' },
      { id: 'cancellation', type: 'boolean' },
      { id: 'rejected', type: 'boolean' },
      { id: 'rejection', type: 'boolean' },
      { id: 'left_to_pay', type: 'number' },
      { id: 'aid', type: 'number' },
      { id: 'invoice_id', type: 'number' },
      { id: 'due_date', type: 'date' },
      { id: 'due', type: 'number' },
      { id: 'payer_name', type: 'string' },
      { id: 'amount', type: 'number' },
      { id: 'lastname', type: 'string' },
      { id: 'firstname', type: 'string' },
      { id: 'country_code', type: 'number' },
      { id: 'payment_method', type: 'string' },
      { id: 'urt', type: 'date' },
      { id: 'invoice_date', type: 'date' },
      { id: 'total_paid', type: 'number' },
      { id: 'left_to_pay', type: 'number' },
      { id: 'vatable_left_to_pay', type: 'number' },
      { id: 'waiting_payments', type: 'number' },
      { id: 'paid',
        inputConfig: {
          inputType: 'select',
          options: [
            { value: '0', label: 'not paid / doesn\'t exist' },
            { value: '1', label: 'paid' },
      ...
      { id: 'dir', type: 'string', title: 'Directory' },
      { id: 'gateway_details.transaction_exhausted', type: 'boolean', title: 'Transaction Exhausted' },
      { id: 'gateway_details.four_digits', type: 'string', title: '4 Digits' },
      { id: 'left', type: 'number', title: 'Left' },
      { id: 'waiting_for_confirmation', type: 'boolean', title: 'Waiting For Confirmation' },
      { id: 'txid', type: 'string', title: 'txid' },
      { id: 'vendor_response.status', type: 'string', title: 'Vendor Response Status' },
      { id: 'last_checked_pending', type: 'date', title: 'Last Checked Pending' },
      { id: 'original_txid', type: 'string', title: 'Original txid' },
