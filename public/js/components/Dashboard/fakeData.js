...
export const fakeDoughnutDetails = () => delay(3, true, Immutable.fromJS({
...
export const fakeDoughnutLegend = () => delay(2, true, Immutable.fromJS({
  labels: ['Existing', 'New', 'Dorm.', 'Churn'],
  values: Array.from(Array(4)).map(() => faker.random.number({ min: 0, max: 200 })),
}));

export const fakePercentBar = () => delay(1, true, Immutable.fromJS({
  values: Array.from(Array(12)).map(() => faker.random.number({ min: 0, max: 800 })),
}));

export const fakeLines = () => delay(5, true, Immutable.fromJS({
  x: [{
    label: 'AVG',
...
export const fakeBar = () => delay(4, true, Immutable.fromJS({
  x: [{
    label: '2015',
    values: Array.from(Array(12)).map(() => faker.random.number({ min: 5000, max: 50000 })),
  }, {
