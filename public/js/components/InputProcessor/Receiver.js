    ...
    return (
      <div className="ReceiverSettings">
        ...
        <form className="form-horizontal">
          ...
          <div className="form-group">
            <label htmlFor="host" className="col-md-2 control-label">Host</label>
            <div className="col-md-4">
          ...
          <div className="form-group">
            <label htmlFor="delete_received" className="col-md-2 control-label">Delete on retrieve</label>
            <div className="col-md-4">
          ...
          <div className="form-group">
            <label htmlFor="passive" className="col-md-2 control-label">Passive</label>
            <div className="col-md-4">
