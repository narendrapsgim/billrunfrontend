...
export default class PlanProductsPriceList extends Component {
  ...
  renderItems(){
    const { planName, planProducts, productPlanPrice } = this.props;
    const products = productPlanPrice.map( (key, i) => {
